...
#hmm what else to add here to fix this
mean(x)
```
...
#The data is not able to be fully calculated. It seems the data entered is prioritizing NA over the numeric values also present in the data.
