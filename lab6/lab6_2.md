...
## 3 Torgersen          1
```
#We have NA here as some of the data collected might have been inconclusive or there was no data to initially collect. No, it looks like Dream island isn't lacking penguin data.
...
```
## # A tibble: 1 x 5
##   mean_bill_length_… mean_bill_depth_… mean_flipper_leng… mean_body_mass_g     n
##                <dbl>             <dbl>              <dbl>            <dbl> <int>
...
## 3 Gentoo         5
```
#There are 6 & 5 penguins in Adelie and Gentoo species, respectively, that have NA for there sex.
